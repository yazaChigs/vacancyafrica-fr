...
// github
import { GithubDiscussComponent } from 'src/app/layouts/pages/github/discuss/discuss.component'
import { GithubExploreComponent } from 'src/app/layouts/pages/github/explore/explore.component'
